...
```sh
composer require magento-com/php-mutex
```
...
The
[`Mutex`](https://github.com/magento-mcom/php-mutex/api/class-malkusch.lock.mutex.Mutex.html)
provides the API for this library.

### Mutex::synchronized()

[`Mutex::synchronized()`](https://github.com/magento-mcom/php-mutex/api/class-malkusch.lock.mutex.Mutex.html#_synchronized)
...
[`Mutex::check()`](https://github.com/magento-mcom/php-mutex/api/class-malkusch.lock.mutex.Mutex.html#_check)
...
[`CASMutex::notify()`](https://github.com/magento-mcom/php-mutex/api/class-malkusch.lock.mutex.CASMutex.html#_notify).
